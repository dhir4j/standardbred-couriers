...
def price_calculator():
    try:
        ...
        # The frontend sends 'Express', 'Air', 'Road', 'Train', so we map them
        mode_map = {
            "Express": "express",
            "Air": "air",
            "Road": "surface",
            "Train": "surface", # Assuming Train uses surface pricing
            # Direct mappings
            "express": "express",
            "air": "air",
            "surface": "surface",
        ...
        return jsonify({
            ...
            "mode": frontend_mode.title() if frontend_mode else "N/A",
            "weight_kg": weight,
