...
function getStoryText(x, y, radius, merges, fps) {
  ...
  return `Navegamos el talento,(${x}, ${y})<br> desafíos reales privados y sociales ${radius} y las nuevas tecnologías <br>para acelerar ${merges} los procesos de innovación: ${fps}`;
}
